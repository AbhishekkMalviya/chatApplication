...
public class Server implements ActionListener { // JFrame ko extend nahi kr k uska object banaya because we have to call
                                                // validate() method and it is non static
                                                // (WE HAVE TO EXTEND STATICALLY) JFrame ka object baninge
    ...
    static Box vertical = Box.createVerticalBox(); // isko static declear is lie kia kyoki static function se non-static
                                                   // method call nahi kar sakte and i use it in main method and as we
                                                   // know it is static (oBviously:)
    static JFrame f = new JFrame();
